...
public class AddController implements Initializable {
  ...
  //------------------------------------------generate academ number--------------------------------------


    @FXML
    void Add_Number(ActionEvent event) {
//    	academNumber = JOptionPane.showInputDialog(null, " Enter Academic Number");
    	TextInputDialog dialog = new TextInputDialog();
        dialog.setTitle("Enter Accadimic Number");
        ...
        if (result.isPresent()) {
        	academNumber = result.get();
        }
        Academ_txt.setText(academNumber);
...
//----------------------------------------Add Button--------------------------------
    ...
    private void Add_Student(ActionEvent event) throws SQLException, IOException {
        ...
        String password=Password_txt.getText();
         String sql1 = "INSERT INTO `fci_registration`.`students` (first_name, last_name, email,password,accadimic_number) VALUES ('" + first + "','" + last + "','" + email + "','" + password + "','" + academ + "')";
...
//            Coursesubm.getItems().add(register);
            ...
            academNumber=Integer.toString(Integer.parseInt(academNumber)+1);
            Academ_txt.setText(academNumber);
    ...
    public void loaddatafromDB() throws SQLException {
        ...
        academNumber=Integer.toString(Integer.parseInt(Number)+1);
        Academ_txt.setText(academNumber);
        Academ_txt.setEditable(false);
